---
title: "Control other computers"
description: "How to operate another computer using Zo"
...
<Frame>
  <img
    className="block"
    src="/screenshots/ssh-mac-remote-login.png"
    alt="How to connect to your server using SSH and use it as a remote development environment"
  />
</Frame>
