...
Once your are files uploaded, you can directly chat with Zo to:
...
Do simple tasks with Zo via text or email, including the following:
...
Keep in mind some more complicated tasks such as summarizing folders or doing image editing are still best over the Zo desktop browser or Zo desktop app.
...
Create these tasks by clicking the calendar button on the left hand hand panel.

<img
  src="/images/Screenshot2025-08-26at6.52.02PM.png"
  alt="Screenshot 2025-08-26 at 6.52.02 PM.png"
  title="Screenshot 2025-08-26 at 6.52.02 PM.png"
  className="mx-auto"
  style={{ width:"34%" }}
/>

Below are 2 examples of scheduled tasks.

![daily reminders.png](/images/dailyreminders.png)
