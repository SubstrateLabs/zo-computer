...
<Frame caption="An SSH service with port 10872 and host ts1.zocomputer.io">
  <img
    className="block"
    src="/screenshots/ssh-service-running.png"
    alt="How to set up an SSH service to connect to your server"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/screenshots/ssh-cursor-config.png"
    alt="How to connect Cursor to a remote development server, step 1"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/screenshots/ssh-cursor-command.png"
    alt="How to connect Cursor to a remote development server, step 2"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/screenshots/ssh-cursor-connect.png"
    alt="How to connect Cursor to a remote development server, step 3"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/screenshots/ssh-cursor-workspace.png"
    alt="How to connect Cursor to a remote development server using SSH"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/screenshots/ssh-cursor-done.png"
    alt="How to connect Cursor to a remote development server – Done!"
  />
</Frame>
