...
This guide will walk you through connecting to your Zo server over SSH. One powerful use case SSH enables is using your Zo as a **remote development environment**, connecting to Zo from your favorite IDE running on your computer.
...
```sh
ssh -p 10872 root@ts1.zo.computer
```
