...
Some people can do practically anything with a computer, because they know how to "speak computer". Now, you can **just talk to Zo**, and do things with a computer that previously required a lot of technical knowledge. 
...
To learn more about what's possible with Zo, come chat with the Zo team and other Zo Computer users on [Discord](https://discord.gg/2eZZ4NWE7G).
