...
description: "Introducing your new workspace"
---
...
- Sync files from your computer to your Zo Computer, using tools like [Syncthing](https://syncthing.net). 
- Set up Zo to control your laptop or other devices at home, using tools like [SSH](https://en.wikipedia.org/wiki/Secure_Shell).
